...
@ControllerAdvice
public class RequestErrorHandlerClass extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        return buildResponseEntity(new ApiResponseClass<>(BAD_REQUEST, error, ex));
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        apiError.setError("Passed in Wrong Parameters");
        apiError.setDebugMessage("check your fields to see if they are correct");
    ...
    protected ResponseEntity<Object> handleEntityNotFound(
        ...
        ApiResponseClass<Object> apiError = new ApiResponseClass<>(NOT_FOUND);
    ...
    protected ResponseEntity<Object> handleHttpMessageNotWritable(HttpMessageNotWritableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return buildResponseEntity(new ApiResponseClass<>(HttpStatus.INTERNAL_SERVER_ERROR, error, ex));
    }
